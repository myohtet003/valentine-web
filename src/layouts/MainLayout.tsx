...
import { Heart, Music, Grid2X2 } from "lucide-react";
...
export default function MainLayout() {
  ...
  // localStorage ကနေ Auth Status ကို စစ်မယ်
  ...
  // --- Security Check ---
  // အကယ်၍ Lock မပွင့်သေးဘဲ /audio သို့မဟုတ် /memory ကို သွားရင် Dashboard (/) ဆီ ပြန်ပို့မယ်
  ...
  return (
    <div className="min-h-screen bg-[#FFF0F3] pb-24">
      ...
      {/* Authenticated ဖြစ်မှသာ Tab Bar ကို ပြမယ် */}
      {isAuthenticated && (
